...
?>
	<tr>
		...
		<td width="800px" ><a  style="text-decoration:none;color:#444444"  href ="../comment/show.php?id=<?php echo $row[0] ?>"><?php echo cut_str($row[1],47)?></a></td>
		<td width="100px"style="cursor:pointer;color:#ff7575" onclick="deleteTheme('<?php echo "$row[0]','$c','content'"?>)">删除</td>
	</tr>
<?php }
echo "</table>";
	   //end show data
   ...
   //参数$link：连接标识符
   //参数$page_size：每页记录数
   function mpaging($cur_page,$sql,$link,$page_size){
	   //获取总记录数
