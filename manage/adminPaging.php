<?php
   function show_result1($sql,$link){
...
?>
	<tr>
		...
		<td width="100px"style="cursor:pointer;color:#ff7575" onclick="deleteTheme('<?php echo "$row[0]','$c','admin'"?>)">删除</td>
	</tr>
<?php }
echo "</table>";
	   //end show data
   ...
   //参数$link：连接标识符
   //参数$page_size：每页记录数
   function apaging($cur_page,$sql,$link,$page_size){
	   //获取总记录数
